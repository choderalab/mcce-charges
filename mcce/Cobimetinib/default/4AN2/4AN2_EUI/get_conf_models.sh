...
# Input:
# First arg=resID
# The second argument is the column number in fort.38 at which the most occupied conformers will be retrieved.
# If the 3rd argument is not 0 (0=do not convert step2 format), the corrdinate file will be a standard pdb.
...
# Example: get_conf_models.sh A0100 2 0
#
if [[ $# -lt 3 ]]; then
